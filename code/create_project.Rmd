...
```{r download_data}
download.file(url = "https://raw.githubusercontent.com/GenomicsAotearoa/RNA-seq-workshop/master/4.Differential_Expression/yeast_counts_all_chr.txt", destfile = here("rnaseq/yeast_counts_all_chr.txt"))
```
...
```{r do_analysis, message=FALSE, warning=FALSE, results=FALSE}
