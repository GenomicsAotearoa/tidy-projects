...
#copy shell scripts
file.copy(here("code/load_modules.sh"), here("rnaseq/"))

#copy slurm scripts
file.copy(here("code/run_analysis.sl"), here("rnaseq/"), )

# copy R scripts
file.copy(here("code/analysis.R"), here("rnaseq/"))

# run R script to generate results
